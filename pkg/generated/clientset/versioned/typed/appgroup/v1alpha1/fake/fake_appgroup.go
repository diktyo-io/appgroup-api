...
var noderesourcetopologiesResource = schema.GroupVersionResource{Group: "appgroup.node.k8s.io", Version: "v1alpha1", Resource: "noderesourcetopologies"}

var noderesourcetopologiesKind = schema.GroupVersionKind{Group: "appgroup.node.k8s.io", Version: "v1alpha1", Kind: "NodeResourceTopology"}
